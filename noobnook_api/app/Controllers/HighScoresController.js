...
class HighScoresController {
    ...
    async getHighScoreConnect4(ctx) {
        return new Promise((resolve, reject) => {
            const query = ` SELECT HS_Connect4 
            ...
            dbConnection.query({
                ...
                if (error) {
                    console.log("Connection error in HighScoresController:getHighScoresConnect4", error);
                    ctx.body = [];
                    ctx.status = 200;
                    return reject(error);
                }
    ...
    /// getting highscore 2048
    async getHighScore2048(ctx) {
        return new Promise((resolve, reject) => {
            const query = ` SELECT HS_2048
                            FROM user_highscores
                            WHERE username = ?
                            `;
            dbConnection.query({
                ...
                if (error) {
                    console.log("Connection error in HighScoresController:getHighScores2048", error);
                    ctx.body = [];
                    ctx.status = 200;
                    return reject(error);
                }
    ...
    async postNewHighScoreConnect4(ctx) {
        console.log('postNewHighSCoreConnect4 called');
        return new Promise((resolve, reject) => {
            const query = `UPDATE user_highscores SET HS_Connect4 = ? WHERE username = ?;
                            `;
            dbConnection.query({
                sql: query,
                values: [ctx.params.score, ctx.params.username]
                ...
                if (error) {
                    console.log("Connection error in HighScoreController::postNewHighScoreConnect4", error);
                    ctx.body = [];
                    ctx.status = 200;
                    return reject(error);
                }
    ...
    async postNewHighScore2048(ctx) {
        console.log('postNewHighSCoreConnect4 called');
        return new Promise((resolve, reject) => {
            const query = `UPDATE user_highscores SET HS_2048 = ? WHERE username = ?;
                            `;
            dbConnection.query({
                sql: query,
                values: [ctx.params.score, ctx.params.username]
                ...
                if (error) {
                    console.log("Connection error in HighScoreController::postNewHighScore2048", error);
                    ctx.body = [];
                    ctx.status = 200;
                    return reject(error);
                }
