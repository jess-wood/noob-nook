...
highScoresRouter.get('/:username/get-2048', HighScoresController.getHighScore2048);
...
highScoresRouter.get('/:score/:username/score-2048', HighScoresController.postNewHighScore2048);
